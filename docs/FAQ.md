...
| **Which scales work?** | Designed first for **Bookoo** Themis Mini/Ultra. Also Acaia, Felicita Arc, AtomHeart Eclair via [EspressoScaleBLE](../libraries/EspressoScaleBLE/README.md#scale-compatibility). See [Scales](settings/scales.md). |
