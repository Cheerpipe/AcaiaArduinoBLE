...
function armSentinel(){const el=$('shotHistorySentinel');if(!el||obs)return;obs=new IntersectionObserver(es=>{if(es.some(e=>e.isIntersecting))R.loadMoreShots()},{rootMargin:'240px'});obs.observe(el)}
