...
<main id="app">
  ...
  <fieldset id="workflowPanel"><legend>Configuration</legend>
    ...
    <details class="cfgGroup"><summary>Fast extraction guard</summary>
      <label><input id="fastExtractionGuardEnabled" type="checkbox"> Enable guard<small class="fieldHint">Off by default. Extends the shot if target is reached before min brew time.</small></label>
      <label class="fastGuardOpt">Max recovery (g)<input id="maxRecoveryWeightG" type="number" min="10" max="200" step="0.1" required><small class="fieldHint">Hard stop while extended (default 42.5 g).</small></label>
      <label class="fastGuardOpt">Min brew time (s)<input id="minBrewTimeS" type="number" min="5" max="55" step="0.5" required><small class="fieldHint">Normal target stop needs at least this time (default 26 s).</small></label>
    </details>
