...
<main id="app">
  ...
  <fieldset id="workflowPanel"><legend>Workflow</legend>
    ...
    <label><input id="brewConfirmationBeep" type="checkbox"> Beep when coffee starts<small class="fieldHint">Beep once when extraction starts after the retare window ends; no beep during retare or on confirmation timeout alone.</small></label>
