...
<main id="app">
  ...
  <fieldset><legend>Shot history</legend>
    ...
    <small>Up to 120 shots. Time is fixed when recorded (timezone at that moment). Without NTP sync, time shows as unavailable.</small>
  </fieldset>
...
function formatShotTime(r){if(r.hasWallTime&&r.endedAtLocalSec)return formatWallTimeLocal(r.endedAtLocalSec);return'#'+r.bootId+' · sin hora'}
